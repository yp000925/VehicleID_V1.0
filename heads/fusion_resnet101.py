...
def head(endpoints, embedding_dim, is_training):
    endpoints['emb1'] = GlobalAveragePooling2D(data_format='channels_last')(endpoints['resnet_v1_101/block1'])
    ...
    endpoints['emb2'] = GlobalAveragePooling2D(data_format='channels_last')(endpoints['resnet_v1_101/block2'])
    ...
    endpoints['emb3'] = GlobalAveragePooling2D(data_format='channels_last')(endpoints['resnet_v1_101/block3'])
    ...
    endpoints['emb4'] = GlobalAveragePooling2D(data_format='channels_last')(endpoints['resnet_v1_101/block4'])
